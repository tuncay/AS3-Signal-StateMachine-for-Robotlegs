...
public class CancelTransitionFromExitingGuardTestingAllRelevantPhasesDispatched implements IResultRegistable {
    ...
    public function cancelled_from_exitingGuard__only_relevant_phases_dispatched_with_params():void {
        _results = [];
        const expected:String =  "[ CancelCommand:: starting | exitingGuard ]," +
                                 "[ CommandC:: starting | exitingGuard | payload/one ]," +
                                 "[ CommandH:: starting | cancelled | reason/testing | payload/one ]," +
