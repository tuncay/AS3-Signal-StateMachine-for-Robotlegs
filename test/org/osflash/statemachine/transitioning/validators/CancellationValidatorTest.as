...
public class CancellationValidatorTest {
    ...
    public function CancellationValidatorTest() {
    }

    [Before]
    public function before():void {
        _testSubject = new CancellationValidator();
    ...
    [Test]
    public function cancellation_from_CANCELLED_phase_returns_false():void {
        _model.transitionPhase = SignalStateTransitionPhases.CANCELLED;
       assertThat( _testSubject.validate( _model ), isFalse() );
    }

    [Test]
    public function cancellation_from_ENTERED_phase_returns_false():void {
        _model.transitionPhase = SignalStateTransitionPhases.ENTERED;
       assertThat( _testSubject.validate( _model ), isFalse() );
    }

    [Test]
    public function cancellation_from_ENTERING_GUARD_phase_returns_true():void {
        _model.transitionPhase = SignalStateTransitionPhases.ENTERING_GUARD;
       assertThat( _testSubject.validate( _model ), isTrue() );
    }

    [Test]
    public function cancellation_from_EXITING_GUARD_phase_returns_true():void {
        _model.transitionPhase = SignalStateTransitionPhases.EXITING_GUARD;
       assertThat( _testSubject.validate( _model ), isTrue() );
    }

     [Test]
    public function cancellation_from_TEAR_DOWN_phase_returns_false():void {
        _model.transitionPhase = SignalStateTransitionPhases.TEAR_DOWN;
       assertThat( _testSubject.validate( _model ), isFalse() );
    }

      [Test]
    public function cancellation_from_NONE_phase_returns_false():void {
